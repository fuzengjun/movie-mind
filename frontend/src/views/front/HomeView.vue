<template>
  <section class="space-y-12">
    ...
    <div class="space-y-12">
      <ContentRail title="热门影视" eyebrow="Featured Row" description="基于当前片库热度与浏览表现展示重点内容。" :movies="movies.slice(0, 8)" />
      <ContentRail title="高分力荐" eyebrow="Top Rated" description="评分、收藏与观看行为共同形成这条精选内容带。" :movies="ratedMovies" />
      <ContentRail title="最新入库" eyebrow="Library Pulse" description="系统近期更新的影片内容，持续推荐最新上映的佳作。" :movies="recentMovies" />
    </div>
  </section>
</template>
