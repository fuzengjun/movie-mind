        ...
        <div class="mt-6 space-y-4 text-[var(--text-secondary)]">
          ...
          <div class="grid gap-4 pt-2 md:grid-cols-2">
            <div class="surface-card-soft p-4">
              <p class="text-sm text-[var(--text-muted)]">TMDB 评分</p>
              <p class="mt-2 text-2xl font-semibold">{{ movie.tmdbRating || 'N/A' }}</p>
            </div>
            <div class="surface-card-soft p-4">
              <p class="text-sm text-[var(--text-muted)]">收藏 / 浏览</p>
              <p class="mt-2 text-2xl font-semibold">{{ movie.favoriteCount || 0 }} / {{ movie.viewCount || 0 }}</p>
            </div>
          </div>
        </div>
      </article>
