...
const routes=[{path:'/',component:FrontLayout,children:[{path:'',name:'home',component:HomeView},{path:'movies',name:'movies',component:MovieListView},{path:'movies/:id',name:'movie-detail',component:MovieDetailView,props:true},{path:'movies/:id/cast',name:'movie-cast',component:MovieCastView,props:true},{path:'people/:type/:id',name:'person-detail',component:PersonDetailView,props:true},{path:'people/:type/:id/works/:sectionKey',name:'person-works',component:PersonWorksView,props:true},{path:'login',name:'login',component:LoginView}]},{path:'/admin',component:AdminLayout,meta:{requiresAdmin:true},children:[{path:'',name:'admin-dashboard',component:DashboardView},{path:'movies',name:'admin-movies',component:MovieManagementView},{path:'users',name:'admin-users',component:UserManagementView},{path:'comments',name:'admin-comments',component:CommentManageView},{path:'content',name:'admin-content',component:ContentManageView},{path:'tmdb',name:'admin-tmdb',component:TmdbManageView}]}]
const router=createRouter({history:createWebHistory(),routes})
router.beforeEach((to)=>{const store=useUserStore();if(to.matched.some(record=>record.meta.requiresAdmin)&&!store.token)return{path:'/login',query:{redirect:to.fullPath}}})
